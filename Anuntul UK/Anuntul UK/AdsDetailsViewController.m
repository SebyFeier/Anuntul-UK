...
//    [self dismissViewControllerAnimated:YES completion:nil];
    [MBProgressHUD showHUDAddedTo:[[UIApplication sharedApplication].delegate window] animated:YES];
    [[WebServiceManager sharedInstance] sendPaymentInformationToServer:paymentMethodNonce.nonce type:paymentMethodNonce.type announcementId:self.announcementType[@"id"] announcementType:self.announcementInfo[@"setari_anunturi_id"] withCompletionBlock:^(NSDictionary *dictionary, NSError *error) {
