                ...
                if (selectedLocation) {
                    ...
                    if (selectedCategory) {
                        ...
                        if (self.agreeSwitch.isOn) {
                            ...
                            NSDictionary *adDetails = [NSDictionary dictionaryWithObjectsAndKeys:@"0",@"afisari", selectedLocation[@"titlu"],@"city",self.descriptionTextView.text,@"descriere",self.phoneTextField.text,@"telefon1", images?images:[NSArray array],@"images", dateString,@"timp", self.titleTextField.text,@"titlu", user,@"user" ,self.republishedAnnouncement[@"id_anunt"],@"id_anunt", nil];
