...
//        [_imageView setImage:[UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:img[@"url"]]]]];
    } else if ([imageInfo isKindOfClass:[NSString class]]) {
        [_imageView hnk_setImageFromURL:[NSURL URLWithString:(NSString *)imageInfo]];
//        [_imageView setImage:[UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:(NSString *)imageInfo]]]];
    }
}
